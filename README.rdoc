...
=== Different Roles and what they can do

*Administrator*
* In charge of assigning employees to jobs they have applied to

*Employer*
* Can create new job listings, and include which skills are required for that job
* Can see a list of potential employees for each job

*Employee*
* Can add personal skills in their profile section
* Can apply to jobs that they have matching skills for



=== Sample App
There is a sample of this app running here: https://marko-g-employee-tool.herokuapp.com
